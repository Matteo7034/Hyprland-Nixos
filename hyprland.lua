...
local terminal    = "kitty -c ~/.config/hypr/kitty/kitty.conf"
...
hl.config({
    general = {
        ...
        col = {
            active_border   = { colors = {"rgba(ff00ffee)", "rgba(ffbbffff)"}, angle = 45 },
...
hl.bind(mainMod .. "+ SHIFT + B", hl.dsp.exec_cmd("$HOME/.config/hypr/scripts/waybar.sh"))
